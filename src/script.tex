...
\begin{center}
	\begin{tabular}{|l|cc|cc|r|}
		...
		\hline
		originales Modell & 2714 & 3045 & 12s \\
		\hline
		Maximum Merge First & 2037 & 7107 & 7s \\
		Remove Nodes & 2038 & 7315 & 10s \\
		Welsh-Powell & 2056 & 7664 & 8s \\
		Minimum (red. Modelle) & 1772 & 7038 &  \\
		\hline
	\end{tabular}
\end{center}
\end{figure}
...
\begin{figure}
	...
	\addplot[color = red!50, fill=red, fill opacity=0.5]
	coordinates{
		(1635, 0)(1655.99, 0)(1656, 2)(1676.99, 2)(1677, 4)(1682.99, 4)(1683, 6)(1696.99, 6)(1697, 8)(1729.99, 8)(1730, 10)(1734.99, 10)(1735, 12)(1739.99, 12)(1740, 14)(1743.99, 14)(1744, 16)(1748.99, 16)(1749, 18)(1752.99, 18)(1753, 20)(1763.99, 20)(1764, 22)(1769.99, 22)(1770, 24)(1786.99, 24)(1787, 26)(1789.99, 26)(1790, 28)(1793.99, 28)(1794, 30)(1807.99, 30)(1808, 32)(1834.99, 32)(1835, 34)(1865.99, 34)(1866, 36)(1887, 36)(1887, 0)
	};

	\node[rotate=90] (source) at (axis cs:1677,20){\mmfh};
	\node (destination) at (axis cs:1677,4){};
	\draw[->](source)--(destination);
	
	\node[rotate=90] (source2) at (axis cs:1770,40){\wph};
	\node (destination2) at (axis cs:1770,24){};
	\draw[->](source2)--(destination2);	
	
	\node[rotate=90] (source3) at (axis cs:1683,40){\rnh};
	\node (destination3) at (axis cs:1683,6){};
	\draw[->](source3)--(destination3);
	...
	\addplot[color = red!50, fill=red, fill opacity=0.5]
	coordinates{
		(1646.3, 0)(1662.99, 0)(1663, 2)(1667.99, 2)(1668, 4)(1669.99, 4)(1670, 6)(1680.99, 6)(1681, 8)(1686.99, 8)(1687, 10)(1691.99, 10)(1692, 12)(1693.99, 12)(1694, 14)(1711.99, 14)(1712, 16)(1718.99, 16)(1719, 18)(1720.99, 18)(1721, 20)(1731.99, 20)(1732, 22)(1736.99, 22)(1737, 26)(1754.99, 26)(1755, 28)(1774.99, 28)(1775, 30)(1784.99, 30)(1785, 32)(1819.99, 32)(1820, 34)(1829.99, 34)(1830, 36)(1846.7, 36)(1846.7, 0)
	};
	
	\node[rotate=90] (source) at (axis cs:1681,21){\mmfh};
	\node (destination) at (axis cs:1681,8){};
	\draw[->](source)--(destination);
	
	\node[rotate=90] (source2) at (axis cs:1687,40){\wph};
	\node (destination2) at (axis cs:1687,10){};
	\draw[->](source2)--(destination2);	
	
	\node[rotate=90] (source3) at (axis cs:1732,35){\rnh};
	\node (destination3) at (axis cs:1732,22){};
	\draw[->](source3)--(destination3);
...
\begin{center}
	\begin{tabular}{|l|ccr|}
		...
		\textbf{} & \textbf{\#nodes} & \textbf{\#states} & \textbf{Zeit} \\
		\hline
		originales Modell & 2215 & 1010 & 5s \\
		\hline
		Maximum Merge First & 1677 & 1681 & 13s  \\
		Remove Nodes & 1683 & 1732 &  9s \\
		Welsh-Powell & 1770 & 1687 & 9s \\
		Minimum (red. Modelle) & 1656 & 1663 &  \\
		\hline
	\end{tabular}
\end{center}
\end{figure}
